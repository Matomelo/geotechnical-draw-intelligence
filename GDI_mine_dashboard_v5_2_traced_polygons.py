...
def polygon_map_figure(results_df, map_image, selected_polygon="A"):
    ...
    # Pixel coordinates traced against lift2east_polygon_map_clean_v2.png (1600 x 1132).
    # The six shapes follow the visible polygon grid and the sloping lower excavation boundary.
    polygon_points = {
        "D": [
            (642, 457), (712, 457), (784, 458),
            (784, 603), (712, 603), (642, 603),
        ],
        "A": [
            (784, 458), (858, 459), (932, 460),
            (932, 603), (858, 603), (784, 603),
        ],
        "E": [
            (642, 603), (712, 603), (784, 603),
            (784, 744), (712, 744), (642, 744),
        ],
        "B": [
            (784, 603), (858, 603), (932, 603),
            (932, 744), (858, 744), (784, 744),
        ],
        "F": [
            (642, 744), (712, 744), (784, 744),
            (784, 892), (760, 888), (736, 882),
            (712, 876), (688, 868), (664, 861), (642, 855),
        ],
        "C": [
            (784, 744), (858, 744), (932, 744),
            (932, 891), (906, 891), (880, 892),
            (854, 893), (828, 893), (804, 892), (784, 892),
        ],
    }
    ...
    for poly, points in polygon_points.items():
        ...
        fig.add_shape(
            ...
            line=dict(color="#0b3d78" if selected else colour, width=7 if selected else 3),
            layer="above",
        )
    ...
    with left:
        ...
        if DEFAULT_MAP_FILE.exists():
            st.plotly_chart(
                ...
                width="stretch", key="polygon_status_map_v52",
