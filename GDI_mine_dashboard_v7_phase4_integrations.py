...
with tab_polygon:
    ...
    summary_cols = ["Polygon", "Status", "Health Score", "Health Rating", "Polygon Tonnes", "Target Tonnes", "Achievement %", "E/P", "E/T", "Events", "Closure mm", "Rate mm/day", "Convergence Risk"]
